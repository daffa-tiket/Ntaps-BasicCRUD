...
// @Param CreatePegawaiRequestDto body pegawai.CreatePegawaiRequestDto true "CreatePegawaiRequestDto"
//
// @Accept json
// @Produce json
// @Success 200 {object} pegawai.CreatePegawaiResponseDto
// @Router /pegawai [post]
func (c *Controller) CreatePegawai(ec echo.Context) error {
	var (
	...
	response, err := c.InterfacesHolder.PegawaiViewService.CreatePegawai(ctx, request)
