...
// @Param DeletePegawaiRequestDto body pegawai.DeletePegawaiRequestDto true "DeletePegawaiRequestDto"
//
// @Accept json
// @Produce json
// @Success 200 {object} pegawai.DeletePegawaiResponseDto
// @Router /pegawai/{id} [delete]
func (c *Controller) DeletePegawai(ec echo.Context) error {
	var (
	...
	request.ID = int_conv
	response, err := c.InterfacesHolder.PegawaiViewService.DeletePegawai(ctx, request)
